...
def CO2VsDisasters2():
    ...
    co2_fossil_world["co2_total_normed"] = co2_fossil_world["co2_total"] / co2_fossil_world[
        (1900 <= co2_fossil_world["year"]) & (co2_fossil_world["year"] <= 1920)]["co2_total"].mean()
    #
    dstr_extrweather["disasters_normed"] = dstr_extrweather["disasters"] / dstr_extrweather[
        (1900 <= dstr_extrweather["year"]) & (dstr_extrweather["year"] <= 1920)]["disasters"].mean()
    dstr_wildfire["disasters_normed"] = dstr_wildfire["disasters"] / dstr_wildfire[
        (1900 <= dstr_wildfire["year"]) & (dstr_wildfire["year"] <= 1920)]["disasters"].mean()
    dstr_earthquakes["disasters_normed"] = dstr_earthquakes["disasters"] / dstr_earthquakes[
        (1900 <= dstr_earthquakes["year"]) & (dstr_earthquakes["year"] <= 1920)]["disasters"].mean()
    dstr_flood["disasters_normed"] = dstr_flood["disasters"] / \
                                     dstr_flood[(1900 <= dstr_flood["year"]) & (dstr_flood["year"] <= 1920)][
                                         "disasters"].mean()
    ...
    axL.fill_between(co2_fossil_world.index, np.zeros(len(co2_fossil_world.index)),
                     co2_fossil_world["co2_total_normed"],
                     color=(0.35, 0.35, 0.35), label=r"$CO_2 emissions$")
